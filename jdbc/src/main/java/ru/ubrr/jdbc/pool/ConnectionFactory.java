...
public class ConnectionFactory implements Supplier<Stream<Connection>> {
  ...
  public static void main(String[] args) {
    ...
    @Cleanup InputStream resourceAsStream = ConnectionFactory.class
        .getResourceAsStream("/connectionFactory.properties");
    properties.load(resourceAsStream);

    DriverManager.getConnection("kjhdf", properties);
  }
